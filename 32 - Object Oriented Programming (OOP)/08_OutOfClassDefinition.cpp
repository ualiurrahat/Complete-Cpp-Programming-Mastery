/**
 * @file 08_OutOfClassDefinition.cpp
 * @brief Defines class with declarations in-class, definitions out-of-class.
 *
 * This style keeps the **class body clean** and **method logic separate**.
 *
 * @section intuition Intuition
 * Useful when class is large — keeps header readable.
 * Same as header/source split, but in one file for teaching.
 */
